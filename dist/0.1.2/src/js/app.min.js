! function(a, b, c) {
...
}(window, document), !window.angular.$$csp() && window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>'), ! function(a, b) {
    ...
    }(), angular.module("CaptureCommon", ["CaptureConfigs"]).factory("CaptureMessage", ["CaptureLog", function(a) {
        var b = function(a) {
...
jira.factory("JiraAPIs", ["$http", "$filter", "CaptureConfigs", "CaptureStorage", function(a, b, c, d) {
    var e = {
            APIs: c.get("APIs")
        },
        f = {},
        ...
        i = function(b, c, d, f, i) {
            var j = {
                username: c,
                password: d
            };
            a.post(b + e.APIs.auth, j).success(function(a, c) {
                g = a.name, h(b), "undefined" !== f && f(a, c)
            }).error(function(a, b) {
                "undefined" != typeof i && i(a, b)
            })
        },
        j = function(b, c, d) {
            a.get(b + e.APIs.auth).success(function(a, d) {
                g = a.name, h(b), "undefined" !== c && c(a, d)
            }).error(function(a, b) {
                "undefined" != typeof d && d(a, b)
            })
        },
        k = function(a) {
            var b, d, e, f = [];
            if (b = c.get("projectFilter"), d = c.get("serverName"), !b[d]) return a;
            e = b[d];
            for (var g = 0; g < a.length; g++) - 1 !== e.indexOf(a[g].key) && f.push(a[g]);
            return f
        },
        l = function(a) {
            angular.forEach(e.APIs.info, function(b, c) {
                y(b, function(b) {
                    "projects" == c && (b = k(b)), a(c, b)
                })
            })
        },
        m = function(a, b) {
            return a ? void d.getData("sourceUrl", function(a) {
                var c, d, e;
                c = a.sourceUrl, d = window.screen.width + "x" + window.screen.height, e = "\n\n\n *Zalora Capture Environment Information* \n- URL: " + c + "\n- Screen Resolution: " + d + "\n- User Agent: " + window.navigator.userAgent, b(e)
            }) : void b("")
        },
        n = function(b, c, d, g, h, i, j, k) {
            m(i, function(i) {
                var l = {
                    fields: {
                        summary: g,
                ...
                a.post(f.server + e.APIs.createIssue, l).success(function(a) {
                    j(a)
                }).error(function(a) {
                    k(a)
                })
        ...
        o = function(a) {
            ...
            if (-1 == a.indexOf(g)) return d = a.split(","), b = d[0].split(":")[1], c = decodeURIComponent(d[1]), new Blob([c], {
                type: b
            });
            d = a.split(g), b = d[0].split(":")[1], c = window.atob(d[1]), e = c.length, f = new Uint8Array(e);
            for (var h = 0; e > h; ++h) f[h] = c.charCodeAt(h);
            return new Blob([f], {
                type: b
            })
        },
        ...
        q = function(a, c, d, g, h) {
            var i = f.server + e.APIs.attachToIssue.replace("{issueId}", a),
                j = new FormData;
            d = d.replace("%s", b("date")(Date.now(), "yyyy-MM-dd 'at' h:mma")), j.append("file", c, d), p(i, j, g, h)
        },
        r = function(a, b, c, d) {
            for (var g = f.server + e.APIs.attachToIssue.replace("{issueId}", a), h = new FormData, i = 0; i < b.length; i++) {
                h.append("file", b[i]._file, b[i]._file.name);
                console.log(b[i]._file, b[i]._file.name);
            }
            p(g, h, c, d)
        },
        s = function(a, b, c, d) {
            q(a, o(b), "Screen Shot %s.png", c, d)
        },
        t = function(a, b, c, d) {
            r(a, b, c, d)
        },
        u = function(a, b, c, d, e) {
            c = new Blob([JSON.stringify(c)], {
                type: "application/json"
            }), q(b, c, a + " %s.json", d, e)
        },
        v = function(a, b, c, d) {
            u("Recording Data", a, b, c, d)
        },
        w = function(a, b, c, d) {
            u("Javascript errors", a, b, c, d)
        },
        x = function(b, c) {
            a["delete"](f.server + e.APIs.logOut).success(function(a) {
                b(a)
            })
        },
        y = function(b, c, d) {
            a.get(f.server + b).success(function(a) {
        ...
        z = function(a, b) {
            y(e.APIs.info.projects, a, b)
        },
        A = function(a, b, c) {
            var d = encodeURIComponent("project=" + a + " and status != Resolved and status != Closed");
            y(e.APIs.searchIssue.replace("{query}", d), b, c)
        },
        B = function(a, b, c) {
            y(e.APIs.getAttachment.replace("{issueId}", a), b, c)
        },
        C = function(a, b, c) {
            B(a, function(a) {
                var c = {};
                for (var d in a.fields.attachment) {
                    var e = a.fields.attachment[d];
                    "application/json" == e.mimeType && -1 != e.filename.indexOf("Recording Data") && (c[e.id] = e)
                }
                b(c)
            }, function(a) {
                c(a)
    ...
    return {
        auth: i,
        getCurUser: j,
        fetchAllAtlassianInfo: l,
        createIssue: n,
        attachScreenshotToIssue: s,
        attachRecordingData: v,
        attachJavascriptErrors: w,
        attachImages: t,
        generateMetaData: m,
        logOut: x,
        getProjects: z,
...
app.config(["$httpProvider", function(a) {
    a.defaults.headers.post["x-restlogin"] = !0
}]), app.factory("CaptureListener", ["JiraAPIs", "$rootScope", "CaptureLog", "CaptureMessage", "Drawer", function(a, b, c, d, e) {
    var f = Snap("#draw-canvas"),
        g = null,
        h = function() {
            d.addListener(i), b.actions = ""
        },
        i = {
            updateScreenshot: function(a) {
                var h;
                g && g.remove(), h = new Image, h.onload = function() {
                    g = f.image(a, 0, 0, this.width, this.height), f.attr("width", this.width / window.devicePixelRatio), f.attr("height", this.height / window.devicePixelRatio), g.attr("transform", "scale(" + 1 / window.devicePixelRatio + ")")
                }, h.src = a, d.sendMessage("getUserActions", null, function(a) {
                    c.log("getUserActions", a), b.$apply(function() {
                        b.actions = a.length ? a.join("\n") : ""
                    })
                }), e.reset(), e.clearToolbox()
            },
            updateConsoleErrors: function(a) {
                b.$apply(function() {
                    b.consoleLogs = a
                })
            }
...
}]), app.factory("Tool", ["DrawSettings", "CaptureLog", function(a, b) {
    var c = function(a, b) {
        this.params = {
            hooks: {
        ...
        }, this.params = angular.extend(this.params, a), this.handlers = b, this.elements = [], this.activeElement = null
    };
    return c.prototype.mousedown = function(a, c) {
        b.log("mousedown", a, c), this.params.hooks.beforeMousedown.call(this, a, c), this.activeElement || (this.activeElement = this.params.createElement.call(this, a, c), this.elements.push(this.activeElement)), this.params.events.mousedown ? this.params.events.mousedown.call(this, a, c) : (this.setStartPoint(a, c), this.setEndPoint(a, c), this.render())
    }, c.prototype.mouseup = function(a, c) {
        if (b.log("mouseup", a, c), this.params.events.mouseup) this.params.events.mouseup.call(this, a, c);
        else {
            if (this.isSamePoint() && this.activeElement) return b.log("isSamePoint"), this.activeElement.remove(), this.activeElement = null, void this.elements.splice(this.elements.length - 1, 1);
            this.render(), this.activeElement = null
        }
    }, c.prototype.mousemove = function(a, c) {
        b.log("mousemove", a, c), this.params.events.mousemove ? this.params.events.mousemove.call(this, a, c) : (this.setEndPoint(a, c), this.render())
    }, c.prototype.setStartPoint = function(a, b) {
        this.activeElement.pStart = {
            x: a,
            y: b
        }
    }, c.prototype.setEndPoint = function(a, b) {
        this.activeElement.pEnd = {
            x: a,
            y: b
        }
    }, c.prototype.render = function() {
        b.log(this.params.attrs);
        for (var c in this.params.attrs) {
            var d;
            d = "color" == this.params.attrs[c] ? a.get("color") : this.params.attrs[c], this.activeElement.attr(c, d)
        }
        this.params.render.call(this)
    }, c.prototype.isSamePoint = function() {
        return b.log(this.activeElement.pStart, this.activeElement.pEnd), this.activeElement.pStart.x == this.activeElement.pEnd.x && this.activeElement.pStart.y == this.activeElement.pEnd.y
    }, c.prototype.runHook = function(a) {
        this.params.hooks[a] && this.params.hooks[a].call(this)
    }, c
}]), app.factory("Drawer", ["JiraAPIs", "Tool", function(a, b) {
    var c = {},
        d = null,
        e = {};
    return {
        ...
        addTool: function(a, d) {
            c[a] = new b(d, e)
        },
        setActiveTool: function(a) {
            d && c[d].activeElement && c[d].render(), d = a
        },
        onClickOnDocument: function() {
            d && c[d].runHook("clickOnDocument")
        },
        clearToolbox: function() {
            d && c[d].runHook("clearToolbox")
        },
        getTools: function() {
            return c
        },
        ...
        reset: function() {
            for (var a in c) {
                var b = c[a];
                for (var d in b.elements) b.elements[d].remove()
            }
        },
        ...
        exportImage: function(a) {
            ...
            var f = d.getContext("2d"),
                ...
                h = this.utf8ToBase64(c);
            g.setAttribute("src", "data:image/svg+xml;base64," + h), g.onload = function() {
                f.drawImage(g, 0, 0);
                var b = d.toDataURL("image/png");
                if ("undefined" == typeof a) {
                    var c = document.createElement("a");
                    c.download = "download.png", c.href = b, c.click()
                } else a(b)
            }
        }
    }
...
}), app.directive("captureTextLayer", ["Drawer", "$timeout", function(a, b) {
    return {
        restrict: "A",
        link: function(a, c, d) {
            a.$watch(d.captureFocus, function(e) {
                e === !0 && (a[d.captureFocus] = !1, b(function() {
                    c[0].focus()
                }))
            })
        }
    }
}]), app.directive("captureCanvas", ["Drawer", function(a) {
    return {
        restrict: "A",
        controller: "DrawController",
        link: function(b, c, d) {
            b.canvas = Snap("#draw-canvas");
            var e = function(b, c, d) {
                    a.getActiveTool() && "undefined" != typeof a.getActiveTool()[b] && a.getActiveTool()[b](c, d)
                },
                f = function(a) {
                    var b = {};
                    return b = "text" == a.target.nodeName ? {
                        x: a.offsetX + a.target.offsetLeft,
                        y: a.offsetY + a.target.offsetTop
                    } : "tspan" == a.target.nodeName ? {
                        x: a.offsetX + a.target.offsetLeft,
                        y: a.target.offsetTop
                    } : {
                        x: a.offsetX,
                        y: a.offsetY
                    }
            ...
            c.on("mousedown", function(a) {
                g = !0;
                var b = f(a);
                e("mousedown", b.x, b.y), a.stopPropagation()
    ...
    return {
        ...
        link: function(a, c, d) {
            if (b.support) {
                var e = a.$eval(d.ngThumb);
                if (b.isFile(e.file) && b.isImage(e.file)) {
                    var f = c.find("img"),
                        g = new FileReader;
                    g.onload = function(a) {
                        f.attr("src", a.target.result)
                    }, g.readAsDataURL(e.file)
                }
            }
        }
    }
}]), app.controller("DrawController", ["CaptureConfigs", "$scope", "Drawer", "$sce", "DrawSettings", function(a, b, c, d, e) {
    b.canvas = Snap("#draw-canvas"), b.colors = a.get("canvas", "colors"), b.textLayer = {
        isShow: !1,
        top: 0,
        left: 0,
        data: ""
    }, b.textlayerData = "", c.set("canvas", b.canvas), c.set("scope", b);
    var f = {
        fill: "transparent",
        stroke: "color",
        "stroke-width": 5,
    ...
    c.addTool("rect", {
        ...
        createElement: function(a, b) {
            return this.handlers.canvas.rect(a, b, 0, 0)
        },
        render: function() {
            var a = Math.abs(this.activeElement.pEnd.y - this.activeElement.pStart.y),
                b = Math.abs(this.activeElement.pEnd.x - this.activeElement.pStart.x),
                c = Math.min(this.activeElement.pStart.x, this.activeElement.pEnd.x),
                d = Math.min(this.activeElement.pStart.y, this.activeElement.pEnd.y);
            this.activeElement.attr("x", c), this.activeElement.attr("y", d), this.activeElement.attr("height", a), this.activeElement.attr("width", b)
        }
    }), c.addTool("ellipse", {
        id: "ellipse",
        ...
        attrs: f,
        createElement: function(a, b) {
            return this.handlers.canvas.ellipse(a, b, 0, 0)
        },
        render: function() {
            var a = Math.abs(this.activeElement.pEnd.y - this.activeElement.pStart.y) / 2,
                b = Math.abs(this.activeElement.pEnd.x - this.activeElement.pStart.x) / 2,
                c = Math.min(this.activeElement.pStart.x, this.activeElement.pEnd.x),
                d = Math.min(this.activeElement.pStart.y, this.activeElement.pEnd.y);
            this.activeElement.attr("cx", c + b), this.activeElement.attr("cy", d + a), this.activeElement.attr("rx", b), this.activeElement.attr("ry", a)
        }
    }), c.addTool("line", {
        id: "line",
        ...
        createElement: function(a, b) {
            return this.handlers.canvas.line(a, b, a, b)
        },
        render: function(a) {
            this.activeElement.attr("x1", this.activeElement.pStart.x), this.activeElement.attr("y1", this.activeElement.pStart.y), this.activeElement.attr("x2", this.activeElement.pEnd.x), this.activeElement.attr("y2", this.activeElement.pEnd.y)
        }
    }), c.addTool("arrow", {
        id: "arrow",
        ...
        createElement: function(a, c) {
            var d, e, f;
            return d = this.handlers.canvas.path("M0,0 L0,6 L6,3 L0,0").attr({
                fill: "color"
            }), f = d.marker(0, 0, 6, 6, 3, 3), e = b.canvas.path(Snap.format("M{x},{y}", {
                x: a,
                y: c
            })), e.attr("marker-end", f), e
        },
        render: function(a) {
            var b = Snap.format("M{x1},{y1} L{x2},{y2}", {
                x1: this.activeElement.pStart.x,
                y1: this.activeElement.pStart.y,
                x2: this.activeElement.pEnd.x,
                y2: this.activeElement.pEnd.y
            });
            this.activeElement.attr("path", b), this.activeElement.attr("marker-end").attr("fill", e.get("color"))
        }
    }), c.addTool("draw", {
        id: "draw",
        attrs: f,
        ...
        createElement: function(a, b) {
            var c = this.handlers.canvas.path(Snap.format("M{x},{y}", {
                x: a,
                y: b
            }));
            return c.points = [
        ...
        events: {
            mousemove: function(a, b) {
                if (this.activeElement.points.length > 1) {
                    var c = this.activeElement.points[this.activeElement.points.length - 1],
                        d = Math.sqrt(Math.pow(a - c[0], 2) + Math.pow(b - c[1], 2));
                    d > 5 && (this.activeElement.points.push([a, b]), this.render())
                } else this.activeElement.points.push([a, b]), this.render()
            },
            mousedown: function(a, b) {},
            mouseup: function(a, b) {
                return this.activeElement.points.length <= 1 ? (this.activeElement.remove(), this.activeElement = null, void this.elements.splice(this.elements.length - 1, 1)) : (this.render(), void(this.activeElement = null))
            }
        },
        render: function() {
            for (var a = this.activeElement.points.length, b = ["M", this.activeElement.points[0][0], ", ", this.activeElement.points[0][1], " "], c = 1; a > c; c++) b.push("L", this.activeElement.points[c][0], ",", this.activeElement.points[c][1], " ");
            b = b.join(""), this.activeElement.attr("path", b)
        }
    }), c.addTool("text", {
        id: "text",
        ...
        createElement: function(a, b) {
            return this.handlers.canvas.text(a, b, "")
        },
        events: {
            mouseup: function(a, b) {
                var c = this.handlers.scope;
                c.$apply(function() {
                    c.textLayer.isShow = !0, c.textLayer.top = b, c.textLayer.left = a, c.textLayer.focus = !0, c.textLayerData = ""
                })
            },
            mousedown: function(a, b) {},
            mousemove: function(a, b) {}
        ...
        hooks: {
            beforeMousedown: function(a, b) {
                this.activeElement && this.render()
            },
            clickOnDocument: function() {
                this.activeElement && (this.render(), this.handlers.scope.textLayer.isShow = !1)
            },
            clearToolbox: function() {
                this.handlers.scope.textLayer.isShow = !1, this.handlers.scope.textLayerData = "", this.handlers.scope.focus = !1
            }
        },
        render: function() {
            var a = this.handlers.scope;
            if ("" === a.textlayerData.trim()) this.activeElement.remove(), this.elements.splice(this.elements.length - 1, 1);
            else {
                var b = a.textlayerData.replace(/<\/div>/g, "").replace(/<div>/g, "<br>").replace(/&nbsp;/g, " ");
                b = b.split("<br>"), this.activeElement.attr("text", b), this.activeElement.selectAll("tspan:nth-child(n+2)").attr({
                    dy: "1.4em",
                    x: this.activeElement.attr("x")
                }), a.textlayerData = ""
            }
            a.textLayer.focus && !a.$$phase && a.$apply(function() {
                a.textLayer.focus = !1
            }), this.activeElement = null
        }
    }), c.setActiveTool("rect"), b.tools = c.getTools(), b.activeTool = c.getActiveTool(), b.setActiveTool = function(a) {
        c.setActiveTool(a), b.textLayer.isShow = !1, b.activeTool = c.getActiveTool()
    }, b.setActiveColor = function(a) {
        b.activeColor = a, e.set("color", a)
    }, b.setActiveColor(b.colors[0]), b.$sce = d, b.clearItems = function() {
        c.reset()
    }, b.notSorted = function(a) {
        return a ? Object.keys(a) : []
    }, b.exportImage = function() {
        c.exportImage()
    }
}]), app.controller("MainController", ["CaptureConfigs", "CaptureStorage", "$scope", "JiraAPIs", "CaptureListener", "Drawer", "CaptureMessage", "$rootScope", "FileUploader", "$timeout", function(a, b, c, d, e, f, g, h, i, j) {
    var k = function() {
            c.info = {}, c.selected = {}, angular.element(document).ready(function() {
                g.sendMessage("getScreenshot", null, function(a) {
                    a && e.actions.updateScreenshot(a)
                }), g.sendMessage("processConsoleError", null, null)
            }), c.server = a.get("serverUrl"), d.setServer(c.server), d.fetchAllAtlassianInfo(function(a, b) {
                if ("issueTypes" == a) {
                    var d;
                    for (d in b) b[d].subtask && b.splice(d, 1)
                }
                c.info[a] = b, b.length && (c.selected[a] = b[0].id)
            }), l(), c.includeEnv = !0, c.includeConsoleLogs = !0
        },
        l = function() {
            var a = h.uploader = new i({});
            a.filters.push({
                name: "imageFilter",
                fn: function(a, b) {
                    var c = "|" + a.type.slice(a.type.lastIndexOf("/") + 1) + "|";
                    return -1 !== "|jpg|png|jpeg|bmp|gif|".indexOf(c)
                }
            }), h.addedFileItems = [], a.onAfterAddingAll = function(a) {}
        },
        m = function(a, b, c) {
            if (a && a.steps && a.elems) {
                var d = a.steps;
                for (var e in d)
                    if (-1 == b.indexOf(e)) {
                        var f = d[e].elemId;
                        a.elems[f] && delete a.elems[f], c[e] && delete c[e], delete d[e]
                    }
            }
        };
    c.saveIssue = function() {
        c.loading = "Creating issue..", c.issueError = !1, async.parallel({
            issueId: function(a) {
                d.createIssue(c.selected.projects, c.selected.issueTypes, c.selected.priorities, c.summary, c.description, c.includeEnv, function(b) {
                    c.newIssue = b, a(null, b.id)
                }, function(b) {
                    a(null, null)
                })
            },
            screenshot: function(a) {
                f.exportImage(function(b) {
                    a(null, b)
                })
            }
        }, function(a, e) {
            async.series({
                issueId: function(a) {
                    return e.issueId ? (c.loading = "Uploading attachments..", void d.attachScreenshotToIssue(e.issueId, e.screenshot, function(b) {
                        a(null, e.issueId)
                    }, function(b) {
                        a(null, e.issueId)
                    })) : (c.loading = !1, c.newIssue = !1, c.issueError = "Can not create this issue type in this project! Please reconfig 'Issue Type Schemes' in JIRA or choose a difference issue type.", a(!0, null))
                },
                startUrl: function(a) {
                    b.getData("recordingStartUrl", function(b) {
                        a(null, b.recordingStartUrl)
                    })
                },
                recordingData: function(a) {
                    if (!c.actions.trim()) return a(null, null);
                    var b = c.actions.split("\n");
                    g.sendMessage("getRecordingData", null, function(d) {
                        m(d.infoMap, c.actions, d.screenshots), d.infoMap ? a(null, {
                            script: b,
                            infoMap: d.infoMap,
                ...
                return b.issueId ? void async.series([function(a) {
                    var e = c.uploader.queue;
                    return e.length ? (c.loading = "Uploading attached images..", void d.attachImages(b.issueId, e, function(b) {
                        return c.uploader.clearQueue(), a(null, null)
                    })) : a(null, null)
                }, function(a) {
                    return b.recordingData ? (b.recordingData.startUrl = b.startUrl, c.loading = "Uploading user actions data..", void d.attachRecordingData(b.issueId, b.recordingData, function(b) {
                        a(null, null)
                    }, function(b) {
                        a(null, null)
                    })) : a(null, null)
                }, function(a) {
                    return c.includeConsoleLogs && c.consoleLogs && c.consoleLogs.length ? (c.loading = "Uploading console logs data..", void d.attachJavascriptErrors(b.issueId, c.consoleLogs, function() {
                        return a(null, null)
                    })) : a(null, null)
                }, function(a) {
                    return j(function() {
                        c.loading = !1, h.actions = "", c.summary = "", c.description = "", h.consoleLogs = []
                    }), a(null, null)
                }]) : !1
            })
        })
    }, h.onClickOnDocument = function() {
        f.onClickOnDocument()
    }, k()
}]);
